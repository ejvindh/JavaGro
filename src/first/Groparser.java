...
public class Groparser {
	...
	public static String parse_entry(ArrayList<Byte> entry_data, int entry_id) throws UnsupportedEncodingException {
		int key_offset =((entry_id + 0x170A8) * 1103) % 414;
		ArrayList<String> entry_data_chr = new ArrayList<String>();
	...
	public static String sub(StringBuffer org_data, String oldstring, String newstring) {
		StringBuffer resulting_data = new StringBuffer(org_data.toString());
		int start = 0;
	...
	public static String split_to_string(String data) {
